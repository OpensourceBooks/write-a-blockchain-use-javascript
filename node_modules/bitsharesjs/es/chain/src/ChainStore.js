...
var ChainStore = function () {
                    ...
                    switch (objectType) {
                        ...
                        case "proposal":
                            _this2.subbed_accounts.forEach(function (acc) {
                                ...
                                if (current) {
                                    var proposals = current.get("proposals", Immutable.Set());
    ...
    ChainStore.prototype.getBalanceObjects = function getBalanceObjects(address) {
        ...
        if (current === undefined) {
            ...
            Apis.instance().db_api().exec("get_balance_objects", [[address]]).then(function (balance_objects) {
                ...
                _this7.balance_objects_by_address.set(address, Immutable.Set(set));
    ...
    ChainStore.prototype._updateObject = function _updateObject(object) {
        ...
        */
        ...
        /* New object */
        if (current === undefined || current === true) this.objects_by_id.set(object.id, current = Immutable.fromJS(object));
        ...
        switch (objectType) {
            ...
            case "call_order":
                ...
                if (call_account && call_account !== true) {
                    if (!call_account.has("call_orders")) call_account = call_account.set("call_orders", new Immutable.Set());
            ...
            case "limit_order":
                ...
                if (limit_account && limit_account !== true) {
                    if (!limit_account.has("orders")) limit_account = limit_account.set("orders", new Immutable.Set());
